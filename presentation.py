...
class Game:
    ...
    welcomeMessage = "You're back into game. You completed the first task – to get all the pieces, and now it is the map."
...
class Player:
    def __init__(self, cid, name):
        self.inventory = []
        #self.inventory.append({'image': os.path("map.jpg")})
        self.diary = []
